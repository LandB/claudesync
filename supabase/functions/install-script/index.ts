...
function generatePowershell(supabaseUrl: string, token: string): string {
  return [
    ...
    '[System.Environment]::SetEnvironmentVariable("CLAUDESYNC_CONFIG", $ConfigFile, "User")',
    '$action = New-ScheduledTaskAction -Execute $NodePath -Argument "`"$AgentBin`"" -WorkingDirectory $AgentDir',
